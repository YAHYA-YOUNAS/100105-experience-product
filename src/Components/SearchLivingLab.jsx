...
import FetchSearchLivingLab from "./Fetching/FetchSearchLivingLab";

const SearchLivingLab = () => {
  const [isDropdownOpen, setIsDropdownOpen] = useState("");
  const [report, setReport] = useState("search-livinglab");
  ...
  return (
    <div className="overflow-hidden md:flex sm:flex md:flex-row  sm:flex-col  w-full  md:gap-40">
      ...
      <div className={`flex-2 w-full mt-16`}>
        <FetchSearchLivingLab />
      </div>
    </div>
  );
};

export default SearchLivingLab;
