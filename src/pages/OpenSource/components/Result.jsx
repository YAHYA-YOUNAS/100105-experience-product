...
function Result({data, email}) {
  ...
  return (
    <div id="results" className="w-11/12 mx-auto text-sm font-poppins px-5 py-3 rounded">
      ...
      <p className="text-justify"><span className="font-bold">Our recommendation:</span> Consult your legal team for license amendments, If not fully compatible, follow conditions and add required liabilities & copyright notices for compliance.</p>
      <hr/>
      ...
      {message && <Message classes="w-fit mx-auto my-1" message={`Results are mailed to: ${email}`}/> }
