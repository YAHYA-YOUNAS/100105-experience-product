...
function Main({handleTryAgainClick}) {
  ...
  return (
    <>
      <div>
        <h1 className="text-[#005734] font-bold text-lg text-center md:text-xl md:text-left">Open Source License Compatibility Tracker</h1>
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <Image classes="w-36" source="./legalzard-logo.png" alternateText="Legalzard Logo"/>
        </div>
      </div>
